...
def getValues():
    ...
    for i in lst:
        ...
        #d['-initialWidth'] = int((d['-minWidth'] + d['-maxWidth'])/2)
    ...
    if d['-minWidth'] > d['-initialWidth']: d['-initialWidth'] = d['-minWidth']
    elif not(not(d['-maxWidth'])) and d['-maxWidth'] < d['-initialWidth']: d['-initialWidth'] = d['-maxWidth']
